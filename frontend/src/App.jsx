  ...
  const getTourSteps = (isFromBIT) => [
    {
      ...
      content: "This is a cybersecurity puzzle game where you need to find hidden passwords and bypass security systems. Use your hacking skills to progress through different levels.",
      icon: "🚀",
      showGif: true,
      gifSrc: isFromBIT 
    ...
    {
      title: "HOW TO PLAY",
      content: "Explore the interface carefully and look for clues hidden in plain sight. Each level contains secrets waiting to be discovered through creative thinking and observation.",
      icon: "🎯",
      showGif: false
    },
    {
      title: "LEADERBOARD & COMPETITION",
      content: "Compete with other players! Your progress is tracked and you can see how you rank against other hackers on the leaderboard. Click the BOARD button in the top navigation to view rankings.",
      icon: "🏆",
      showGif: false,
      showBoardIcon: true
    },
    {
      ...
      content: "You can access this tour guide anytime by clicking on the 'BYPASS' logo or the 'B' button in the top navigation bar if you need a refresher.",
      icon: "💡",
      showGif: false,
      showBypassIcon: true
    },
    {
      title: "READY TO HACK?",
      content: "You're all set! Start exploring the interface and look for your first clue. Remember: think outside the box and question everything you see.",
      icon: "🔓",
      showGif: false
    }
  ];
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      {showTour && (
        <>
          ...
          <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-[110] p-4 w-full max-w-md">
            <div className={`bg-black border-2 border-cyan-400 shadow-lg shadow-cyan-500/50 w-full font-mono transform transition-all duration-500 ease-out ${
              isTourClosing 
              ...
              <div className="border-t-2 border-cyan-400 bg-cyan-900/10 p-3">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-cyan-400 text-xs font-mono">
                    {tourStep === getTourSteps(isFromBIT).length - 1 ? "READY TO START!" : "CONTINUE TOUR"}
                  </div>
                  ...
                  >
                    {tourStep === getTourSteps(isFromBIT).length - 1 ? "FINISH" : "NEXT >"}
                  </button>
                </div>
              </div>
            </div>
      ...
      {showLeaderboard && (
        <>
          ...
          {/* Modal */}
          <div className={`fixed top-0 right-0 h-full w-96 bg-black border-l-2 border-yellow-400 z-50 transform transition-all duration-500 ease-out shadow-2xl shadow-yellow-400/20 ${
